...
var B1_weekday = [ /// 慶応大学 湘南台駅西口　急行　平日
    [7,00,15,32,40,45,55],
    [8,12,22,32,42,55],
    [9,10,30,50],
    [10,00],
...
var B2_weekday = [ /// 慶応大学 湘南台駅西口 普通 平日
    [7,05,28,35,47],
    [8,02,08,18,24,37,50],
    [9,00,20,35],
    [10,07,20,27,40,50],
...
// B3
var B3_weekday = [ /// 慶応大学本館前 湘南台駅西口 急行 平日
    [15,21,28,30,38,51],
    [16,03,20,33,45,58],
    [17,05,18,30,43],
...
var B3_sat = [ /// 慶応大学本館前 湘南台駅西口 急行 土曜日
    [12,48,55],
    [13,07,15,28,36,50],
    [14,00,40],
    [15],
...
// B4
var B4_weekday = [ /// 慶応大学本館前 辻堂駅北口 平日
...
// B5
var B5_weekday = [ /// 公務員住宅入口 上永谷駅前 平日
    [6,39],
    [7,26,43,56],
    [8,10,25,40],
    [9,28],
...
// B6
var B6_weekday = [ /// 公務員住宅入口 上大岡駅 平日
    [5,54,56],
...
// B7
var B7_weekday = [ /// 慶応大学本館前 湘南台　普通　平日
    [15,16,24,31,43,56],
    [16,08,13,25,38,50],
    [17,10,23,35,48,55],
    [18,08,20,40,47],
...
// B8
var B8_weekday = [ /// 慶応大学本館前 湘南台駅西口 普通 平日
...
// B9
var B9_weekday = [ /// 慶応大学本館前 湘南台駅西口 急行 平日
    [7,24,35,48,53,58],
